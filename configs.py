...
class Configs():
    ...
    def db_insert(self):
        return (self.guild_id, self.post_channel, self.prefix, self.options.as_num(), 0, self.roles, [discord.utils.time_snowflake(datetime.datetime.now(pytz.utc))], self.offset)
